				...
				<div className="collapse navbar-collapse" id="navbarSupportedContent">
					<ul className="navbar-nav mr-auto">
						...
						<li className="nav-item mr-3">
							<Nav.Link className="nav-link text-white anchor-item" onClick={() => setIsLoginOpen(true)}>
								{isLoggedIn ? email : 'Log In'}
							</Nav.Link>
						</li>
						<li className="nav-item">
							<Nav.Link className="nav-link text-white anchor-item" onClick={() => setIsRegisterOpen(true)}>
